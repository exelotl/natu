...
// This stuff isn't ever really supposed to get used on PC, but there's a few hacks in here to make TTE work.

void * natuGetSeMem(void);
void * natuGetTileMem(void);
uintptr_t natuGetRegBase(void);
void * natuGetBgPalMem(void);
...
#define REG_BASE		(natuGetRegBase())
...
#define pal_bg_mem		((COLOR*)natuGetBgPalMem())
#define pal_obj_mem		((COLOR*)MEM_PAL_OBJ)
#define pal_bg_bank		((PALBANK*)natuGetBgPalMem())
#define pal_obj_bank	((PALBANK*)MEM_PAL_OBJ)

#define tile_mem		( (CHARBLOCK*)natuGetTileMem())
#define tile8_mem		((CHARBLOCK8*)natuGetTileMem())
#define tile_mem_obj	( (CHARBLOCK*)MEM_VRAM_OBJ)
#define tile8_mem_obj	((CHARBLOCK8*)MEM_VRAM_OBJ)
#define se_mem			((SCREENBLOCK*)natuGetSeMem())
#define se_mat			((SCREENMAT*)natuGetSeMem())

...
macro init*(dcnt: DispCnt, args: varargs[untyped]) =
  
  let d = genSym(nskVar, "dcnt")
...
# var dispstat* {.importc:"REG_DISPSTAT", header:"tonc.h".}: uint16  ## Display status (REG_BASE + 0x00000004)

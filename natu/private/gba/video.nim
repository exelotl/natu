...
var bgofs* {.importc:"((volatile BG_POINT*)(0x04000010))", header:"tonc_types.h".}: array[4, BgOfs]        ## BG scroll registers (write only!)
var bgaff* {.importc:"((volatile BG_AFFINE*)(0x04000020))", header:"tonc_types.h".}: array[2..3, BgAffine] ## \
  ...
  ## 
  ## See :ref:`affinematrices` for more info.

var winh* {.importc:"((volatile WinH*)(0x04000040))", nodecl.}: array[2, WinH]  ## Sets the left and right bounds of a window (write only!)
var winv* {.importc:"((volatile WinV*)(0x04000044))", nodecl.}: array[2, WinV]  ## Sets the upper and lower bounds of a window (write only!)
...
var mosaic* {.importc:"(*(volatile NU16*)(0x0400004C))", nodecl.}: Mosaic        ## Mosaic size register (write only!)
...
var bldy* {.importc:"(*(volatile NU16*)(0x04000054))", nodecl.}: BlendBrightness ## Brightness (fade in/out) coefficient (write only!)

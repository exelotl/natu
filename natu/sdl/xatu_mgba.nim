...
const
  ...
  XATU_REG_WIN0X1* = 0x040
  XATU_REG_WIN0X2* = 0x042
  XATU_REG_WIN1X1* = 0x044
  XATU_REG_WIN1X2* = 0x046
  XATU_REG_WIN0Y1* = 0x048
  XATU_REG_WIN0Y2* = 0x04A
  XATU_REG_WIN1Y1* = 0x04C
  XATU_REG_WIN1Y2* = 0x04E
  GBA_REG_WININ* = 0x050
  GBA_REG_WINOUT* = 0x052
  GBA_REG_MOSAIC* = 0x054
  GBA_REG_BLDCNT* = 0x056
  GBA_REG_BLDALPHA* = 0x058
  GBA_REG_BLDY* = 0x05A
